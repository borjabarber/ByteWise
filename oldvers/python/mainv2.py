...
3. Si la respuesta es incorrecta o incompleta, explica brevemente el concepto correcto.
...
- Escribe de forma clara, concisa y bien estructurada.
- Usa párrafos separados para diferentes ideas.
- Si es útil, usa listas con viñetas o numeradas para explicar conceptos.
- Utiliza signos de puntuación correctos: comas, puntos, etc.
- Comienza con una introducción breve antes de los puntos, si aplica.
